...
// 	public shout: string;
// 	public type: string;
// 	public constructor(name: string, legs: number, shout: string, type: string)
// 	{
// 		this.name = name;
// 		this.legs = legs;
// 		this.shout = shout;
...
// 	public shoutOutLoud()
// 	{
// 		console.log(`${this.name} shouts ${this.shout}!!!`);
// 	}
// }
...
// 	{
// 		super(name, 4, "miauw", "cat");
// 	}
// }
// class HandiCat extends Cat
// {
// 	public handicap: string;
// 	public constructor(name: string, handicap: string)
// 	{
// 		super(name);
// 		this.handicap = handicap;
// 	}
// }
// const animal = new Animal("nova", 4, "miauw", "cat");
// const cat = new Cat("Nyan Nyan");
// const momo = new HandiCat("momo", "stupidity");
// console.log(momo.legs);
